...
\begin{enumerate}
    ...
    Run ”dotnet run example-1.bb” in the project file. The output should be the following:
    ...
    Run ”dotnet run example-2.bb” in the project file. The output should be the following:
    ...
    Run ”dotnet run example-3.bb” in the project file. The output should be the following:
