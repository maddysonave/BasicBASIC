...
The user needs to understand strings and print statements. Strings are a primitive data type in this
language meaning they cannot be broken down into constiuent parts. The print statment, on the other hand, is
a combining form that acts as an 'operation' which takes a string and does something with it (in this case, prints it on screen)
