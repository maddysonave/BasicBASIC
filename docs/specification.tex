...
The 1.0 specification of Basic BASIC is very limited in its scope. It gives users one primitve type (string) and one combining form (PRINT)
...
prettyprint funciton as a result on the terminal.
